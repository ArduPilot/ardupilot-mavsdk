...
screen -dmS ardupilot /home/user/ArduPilot/build/sitl/bin/ardurover -S -w --model rover \
                     --speedup 1 \
                     --defaults /home/user/ArduPilot/Tools/autotest/default_params/rover.parm \
                     -I0 \
